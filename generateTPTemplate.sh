...
sed -i "s|CAL_TPTemplate|CAL_TP$1|g" CMakeLists.txt
...
mv CAL-TPTemplate.iml CAL-TP$1.iml
#Changing modules.xml (Note: here a  '-' was being used instead of '_')
sed -i "s|CAL-TPTemplate|CAL-TP$1|g" modules.xml
...
sed -i "s|CAL-TPTemplate|CAL-TP$1|g" workspace.xml
sed -i "s|CAL_TPTemplate|CAL_TP$1|g" workspace.xml
#Changing .name (weird that it is a file lol)
sed -i "s|CAL_TPTemplate|CAL_TP$1|g" .name
